...
public class MoverProfile  extends AppCompatActivity implements View.OnClickListener{
    ...
    @BindView(R.id.moverOrdersButton)
    Button mMoverOrdersButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMoverOrdersButton.setVisibility(GONE);
